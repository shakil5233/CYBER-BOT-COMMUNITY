...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "monir") || (event.body.toLowerCase() == "monir bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
     return api.sendMessage("উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলেন..!🥰💚😋",threadID);

       
   };

   if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "ceo")) {
   endMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ মনির ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/61570498118978 তার সাতে যোগা যোগ করবেন WhatsApp :- +018638843*, threadID);
   };

   if ((event.body.toLowerCase() == "তোর বস কে ") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:ULLASH ❤️ হাই আমি মেছেন্জার bot  আামার বস মনির আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Ullash ッ❤️ তাকে সবাই মনির এর নামে  জানে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "মুন্নি") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage(" কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস মনির এর বাবি এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "ইবা") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage(" কেউ এই নাম দরে ডাক দিবানা এটা  আরিয়ান  এর বউ জান ..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "Misty") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage(" কেউ এই নাম দরে ডাক দিবানা এটা আমার বস মনির এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "শুমু") || (event.body.toLowerCase() == "farhana")) {
     return api.sendMessage(" কেউ এই নাম দরে ডাক দিবানা এটা আমার বস মনির এর বোন এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "সাইমা ") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰-🌺 আমার বস মনির'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
